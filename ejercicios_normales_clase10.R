...
# Escriba una función que transforme de Farenheit a centigrados
...
# Añada un condicional a su funcion
# dicha condicional que revisa si el input es un caracter
# si el input es un caracter, genere un mensaje de error


?length()

# escriba una funcion que invierta el orden de un vector 


# si requiere usar funciones que no estan en Rbase
# recuerde cargat las librerias necesarias
library("dplyr")
...
# en cada iteración imprima una letra del abecedario, de la última a la primera
...
# cada columna debe tener 100 valores al azar del 1 al 6 (tiradas de dados)
...
# identifique los 5 archivos con mayor número de doble 6
